// Page component for managing Character Quests in the Dungeon Master Companion app.
// Uses the EntityManager component to display and manage character quest data based on the defined entity configuration.
